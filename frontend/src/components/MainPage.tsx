...
export function MainPage({ userData }: MainPageProps) {
  // Mock data for current semester GPA
  ...
  // Mock data for department notices
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground mt-2">
            안녕하세요, {userData?.name}님! 오늘도 좋은 하루 되세요.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Section 1: Current Semester GPA Status */}
          ...
          {/* Section 2: Current Semester Timetable */}
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
          ...
          {/* Section 4: Service Updates / Announcements */}
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
